...
[Releases](../../releases) ページから最新のバイナリをダウンロードします。

```bash
# x86_64 の場合
curl -L https://github.com/<owner>/AgentsBuilder/releases/latest/download/agentsbuilder-linux-amd64 \
  -o agentsbuilder
chmod +x agentsbuilder
